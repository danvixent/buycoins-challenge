...
type ComplexityRoot struct {
	Query struct {
		CalculatePrice func(childComplexity int, typeArg *Type, margin *float64, exchangeRate *float64) int
	}
}

type QueryResolver interface {
	CalculatePrice(ctx context.Context, typeArg *Type, margin *float64, exchangeRate *float64) (*float64, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.calculatePrice":
		...
		return e.complexity.Query.CalculatePrice(childComplexity, args["type"].(*Type), args["margin"].(*float64), args["exchangeRate"].(*float64)), true
...
func (ec *executionContext) _Query_calculatePrice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().CalculatePrice(rctx, args["type"].(*Type), args["margin"].(*float64), args["exchangeRate"].(*float64))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
